...
INSERT INTO user_table (name, surname, username, password, email, profile_photo_route, authorities) 
VALUES ('user', 'user', 'user1', '$2a$10$fXqx5bUhHJMa2UXfMpWaf.sRAO5sWTYeDDFjLwjnG.fx4oAgxyD4a', 'user1@example.com', 'a', 1),
       ('user', 'user', 'user2', '$2a$10$fXqx5bUhHJMa2UXfMpWaf.sRAO5sWTYeDDFjLwjnG.fx4oAgxyD4a', 'user2@example.com', 'a', 1),
       ('admin', 'admin', 'admin1', '$2a$10$fXqx5bUhHJMa2UXfMpWaf.sRAO5sWTYeDDFjLwjnG.fx4oAgxyD4a', 'admin1@example.com', 'a', 2);
