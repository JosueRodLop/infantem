...
public class ExceptonHandleController {
    ...
    @ApiResponse(responseCode = "404", description = "Recurso no encontrado", content = @Content(schema = @Schema(implementation = ErrorMessage.class)))
    ...
    @ApiResponse(responseCode = "403", description = "Recurso no es propiedad del usuario", content = @Content(schema = @Schema(implementation = ErrorMessage.class)))
    ...
    @ApiResponse(responseCode = "400", description = "Error de validación de datos", content = @Content(schema = @Schema(implementation = ErrorMessage.class)))
