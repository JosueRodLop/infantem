...
public class NutrientController {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de nutrientes encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Nutrient.class)))
    @GetMapping
    ...
    @ApiResponse(responseCode = "200", description = "Nutriente encontrado", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Nutrient.class)))
    ...
    @ApiResponse(responseCode = "201", description = "Nutriente creado con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Nutrient.class)))
    @PostMapping
    ...
    @ApiResponse(responseCode = "200", description = "Nutriente actualizado con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Nutrient.class)))
    @ApiResponse(responseCode = "404", description = "Nutriente no encontrado")
