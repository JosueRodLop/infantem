...
public class NutritionalContributionFoodSourceController {
    ...
    @ApiResponse(responseCode = "200", description = "Lista de fuentes alimenticias asociadas a contribuciones nutricionales encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NutritionalContributionFoodSource.class)))
    @GetMapping
    ...
    @ApiResponse(responseCode = "200", description = "Fuente alimenticia asociada a contribución nutricional encontrada", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NutritionalContributionFoodSource.class)))
    ...
    @ApiResponse(responseCode = "201", description = "Fuente alimenticia asociada a contribución nutricional creada con éxito", content = @Content(mediaType = "application/json", schema = @Schema(implementation = NutritionalContributionFoodSource.class)))
    @PostMapping
