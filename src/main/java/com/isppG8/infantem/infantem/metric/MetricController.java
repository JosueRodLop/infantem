...
public class MetricController {
    ...
    @Operation(summary = "Eliminar una métrica", description = "Elimina una métrica del sistema.")
    @ApiResponse(responseCode = "204", description = "Métrica eliminada con éxito")
    @ApiResponse(responseCode = "404", description = "Métrica no encontrada")
    @DeleteMapping("/{id}")
